...
default:
    ...
    f = "alert", d = "fade", _ = "show", g = function() {
        ...
        e._removeElement = function(t) {
            var e = this;
            o(t).removeClass(_),
            P.supportsTransitionEnd() && o(t).hasClass(d) ? o(t).one(P.TRANSITION_END,
            function(n) {
    ...
    k = function() {
        ...
        t
    } (), p(document).on(O.CLICK_DATA_API, b,
    function(t) {
        t.preventDefault();
        var e = t.target;
    ...
    j = function(t) {
        ...
        C = function() {
            ...
            C.nextWhenVisible = function() { ! document.hidden && t(this._element).is(":visible") && "hidden" !== t(this._element).css("visibility") && this.next()
            },
            C.prev = function() {
    ...
    H = function(t) {
        ...
        return t(document).on(h.CLICK_DATA_API, p.DATA_TOGGLE,
        function(e) {
    ...
    W = function(t) {
        ...
        return t(document).on(c.KEYDOWN_DATA_API, E, L._dataApiKeydownHandler).on(c.KEYDOWN_DATA_API, y, L._dataApiKeydownHandler).on(c.CLICK_DATA_API + " " + c.KEYUP_DATA_API, L._clearMenus).on(c.CLICK_DATA_API, E,
        function(e) {
            e.preventDefault(),
            e.stopPropagation(),
    ...
    M = function(t) {
        ...
        p = function() {
            ...
            p.show = function(e) {
                ...
                if (!this._isTransitioning && !this._isShown) {
                    ...
                    this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), t(document.body).addClass(f), this._setEscapeEvent(), this._setResizeEvent(), t(this._element).on(h.CLICK_DISMISS, g.DATA_DISMISS,
                    function(t) {
                        return n.hide(t)
                    }), t(this._dialog).on(h.MOUSEDOWN_DISMISS,
                    function() {
                        t(n._element).one(h.MOUSEUP_DISMISS,
                        function(e) {
            ...
            p.hide = function(e) {
                ...
                if (e && e.preventDefault(), !this._isTransitioning && this._isShown) {
                    ...
                    if (t(this._element).trigger(i), this._isShown && !i.isDefaultPrevented()) {
                        ...
                        s ? t(this._element).one(P.TRANSITION_END,
                        function(t) {
            ...
            p._enforceFocus = function() {
                var e = this;
                t(document).off(h.FOCUSIN).on(h.FOCUSIN,
                function(n) {
            ...
            p._setEscapeEvent = function() {
                var e = this;
                this._isShown && this._config.keyboard ? t(this._element).on(h.KEYDOWN_DISMISS,
                function(t) {
            ...
            p._setResizeEvent = function() {
                var e = this;
                this._isShown ? t(window).on(h.RESIZE,
                function(t) {
            ...
            p._showBackdrop = function(e) {
                ...
                if (this._isShown && this._config.backdrop) {
                    ...
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = u, i && t(this._backdrop).addClass(i), t(this._backdrop).appendTo(document.body), t(this._element).on(h.CLICK_DISMISS,
                    function(t) {
        ...
        return t(document).on(h.CLICK_DATA_API, g.DATA_TOGGLE,
        function(e) {
            var i, s = this,
    ...
    K = function(t) {
        ...
        g = function() {
            ...
            g._activate = function(e) {
                ...
                var i = t(n.join(","));
                i.hasClass(c) ? (i.closest(f.DROPDOWN).find(f.DROPDOWN_TOGGLE).addClass(u), i.addClass(u)) : (i.addClass(u), i.parents(f.NAV_LIST_GROUP).prev(f.NAV_LINKS + ", " + f.LIST_ITEMS).addClass(u), i.parents(f.NAV_LIST_GROUP).prev(f.NAV_ITEMS).children(f.NAV_LINKS).addClass(u)),
